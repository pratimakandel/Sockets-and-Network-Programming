...
def print_packet(raw_data):
	if not raw_data:
		return
		#**************** To-Do #1 *******************************
		# Fill in the code to decode an Ethernet frame
		# Make sure to use a try catch an ignore if the 
		# frame is not Ethernet
		# Pull the data out of teh Ethernet from
		# Then print both the mac address of both the sender and 
		# the mac address of the reciever 
		#******************* End-to-Do #1 ***************************
            try:
	...
	#*************** To-Do #2 *************************************
	# Check if you have IP data
	# If no IP data just return
	#*************** End To-Do #2 *********************************
	...
	#******************** To-Do #3 ******************************
	# Now check if we have a tcp packet
	# Check for TCP in the transport layer
	# If so also check if you have HTTP data
	# If you have HTTP data print out the header info:
	# source port, destination port, ACK, and Flags
	# If no HTTP data just print the TCP data
	# !!!!!!!!Replace All The  "#!!!Complete-Code!!!" Comments Below !!!!
	#
	...
	if isinstance(ip.data , dpkt.tcp.TCP):
		...
		#first check if its HTTP data and print that. If not just print
		#the tcp packet data
	...
	#Now check if we have a UDP packet
...
def main():
	...
	##################################################################
	#********************* To-Do #4 *********************************
	# Set up a packet capture object with the following:
	# name = None, promisc=True, immediate=True 
